...
class CNN(nn.Module):
    def __init__(self, init_weights=False):
        ...
        #     for _ in range(11)
        # ])
        self.output0 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output1 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output2 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output3 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output4 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output5 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output6 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output7 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output8 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output9 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
        self.output10 = nn.Sequential(nn.Linear(in_features=1024, out_features=37), nn.Softmax(dim=1))
